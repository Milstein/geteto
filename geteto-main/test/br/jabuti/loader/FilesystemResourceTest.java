...
public class FilesystemResourceTest extends ResourceLoaderTest
{
	@Before
	public void setUp() throws Exception
	{
		rl = new FilesystemResource(TestConfiguration.VALID_DIR);
	}

	@Test
	public void testResourceToFilename()
	{
		assertEquals(FilesystemResource.resourceToFilename(TestConfiguration.VALID_RESOURCE1, true), TestConfiguration.VALID_RESOURCE_FILENAME1);
	}
}
