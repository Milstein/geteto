...
{
	static public final String JABUTI_DEFAULT_INSTR_ATTRIBUTE = "JaBUTi Default Instrumented";
			...
			try {
				...
				if (methods[i].getName().equals("<init>")) {
					...
					InstructionHandle ih = InstructionList.findHandle(ihVec, ihOffset,
									ihOffset.length, superNode.getEnd());

					gi.insertAfter(ih, "aload_0 "
									+ // empilha o objeto
									" ldc \""
									+ className
									+ "\""
									+ // empilha o nome da classe
									" ldc "
									+ i
									+ // empilha o numero do metodo
									" lconst_0 "
									+ // empilha aninhamento que para construtor
									// eh sempre 0
									" ldc "
									+ // empilha o numero do no
									"\"" + superNode.getNumber() + "\" " + "invokestatic "
									+ getProbeClass() + " probe \"(Ljava/lang/Object;"
					...
					for (int m = 0; m < gfc.size(); m++) {
						...
						ih = InstructionList.findHandle(ihVec, ihOffset, ihOffset.length, ey
										.getStart());
					...
					for (int m = 0; m < gfc.size(); m++) {
						...
						String s = probStat + " ldc \""
										...
										" lload "
										+ nextLocal
										+ // empilha nivel de aninhamento
										" ldc "
										+ // empilha o numero do no
										"\"" + gn.getNumber() + "\" " + "invokestatic "
										+ getProbeClass() + " probe \"(" + method
										+ "Ljava/lang/String;IJLjava/lang/Object;)V\"";
					...
					String before, String after)
	{
		...
		try {
			...
			// e finalmente, coloca o tratador de exce��es para todo
			// o c�digo orignal
			iList = mg.getInstructionList();
