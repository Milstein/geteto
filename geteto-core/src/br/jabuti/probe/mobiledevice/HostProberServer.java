...
import br.jabuti.probe.mobiledevice.server.MuConstants;
...
public class HostProberServer extends MuServer
{
	...
	public HostProberServer()
	{
		...
		addUbiquitousPackage("br.jabuti.probe.mobiledevice");
		addUbiquitousPackage("br.jabuti.probe.mobiledevice.mobile");
		addUbiquitousPackage("br.jabuti.probe.desktop");
	}
...
*/
    static public void main(String[] args) throws Exception
    {
		...
		ms.addUbiquitousPackage("br.jabuti.probe.mobiledevice.*");
		ms.boot();
    }
    ...
    {
    	if ( Boolean.valueOf(properties.getProperty(MuConstants.DEBUGkey)).booleanValue())
