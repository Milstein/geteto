 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class FrameDeixarHotel// implements ActionListener
{
	/*JFrame frame;
	...
	public static void setComponente(IOcuparReserva newIOR)
	{		
		IOR = newIOR;
	}
    ...
    public void actionPerformed(ActionEvent event) {
    	...
    	if ((event.getActionCommand().equals("Ocupar Reserva")))
    	 {    	    	    	
    	   System.out.println("Ocupar Reserva");
    	    cli.setCliID(cliID);
