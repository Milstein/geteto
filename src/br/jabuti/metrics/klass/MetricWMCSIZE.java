...
/**
 * Weighted Methods per Class using number of bytecode instructions.
 * Uses the number of bytecode instructions to measure the complexity
 * of a method
 */
public class MetricWMCSIZE extends AbstractMetric
{
	public MetricWMCSIZE()
	{
		super();
		name = "wmc_size";
		description = "Weighted Methods per Class using bytecode count (WMC_SIZE)";
	}
