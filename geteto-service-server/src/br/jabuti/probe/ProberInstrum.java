...
public class ProberInstrum {
    ...
    public static boolean instrumentProject(JabutiProject project, String outName) 
    {
        ...
        try {
            ...
            File outFile = new File(outName);
  			...
  			//modification to get the right classes
  			//change to get the classes from the same project
  			ClassPath cp = new ClassPath("/home/andre/arquivos/QualipsoFolder/Eclipse/commonlib/jabuticlasses");
    ...
    //**********************
    //Andre
    public static boolean instrumentProject(JabutiProject project, String outName, Properties props) 
    {
		Program program = null; // The program to be tested
        HashSet toInstrumenter = null;
        ...
        try {
            ...
            File outFile = new File(outName);
  			...
  			projTomcatPath += "WEB-INF/classes";
